    ...
    <div class="card h-100 border-0 bg-transparent">
      <div class="card-body p-0">
        ...
        <ul class="list-unstyled pl-3">
          ...
          <li>• Malware Analysis & Secure Code Review</li>
          <li>• OWASP Top 10 & Black-box Testing</li>
          <li>• Attack Surface Analysis & Threat Intelligence</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="card h-100 border-0 bg-transparent">
      <div class="card-body p-0">
        ...
        <ul class="list-unstyled pl-3">
          ...
          <li>• Real-Time Systems & Socket.IO</li>
          <li>• Secure Software Development</li>
          <li>• Machine Learning & Blockchain (Solidity)</li>
        </ul>
      </div>
    </div>
  </div>
